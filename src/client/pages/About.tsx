...
export function About() {
  return (
    <div className="about">
      ...
      <p>The Projector is a central portal for projects under professors. This site is under construction, so please don't expect everything to work perfectly :)</p>
      <p>
