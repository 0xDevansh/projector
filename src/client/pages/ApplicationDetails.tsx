...
import { Calendar, GraduationCapIcon, SchoolIcon, UserIcon } from 'lucide-react'
        ...
        <CardContent>
          <div className="grid gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground whitespace-pre-wrap">{application.relevantSkills}</p>
            </div>
            <div>
              <Separator className="my-6" />
