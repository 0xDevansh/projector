...
// copied from https://github.com/tiaanduplessis/react-hook-form-persist/blob/master/src/index.tsx
// because importing the library doesn't work for some reason
...
function usePersist(name: string, {
  storage,
  watch,
  setValue,
  exclude = [],
