...
export function Header() {
  ...
  return (
    <header className="flex flex-col md:flex-row justify-around px-4 md:px-8 py-2 bg-gray-50 drop-shadow-md items-center space-y-2 sticky top-0 z-50 w-full border-b bg-background/90 backdrop-blur supports-[backdrop-filter]:bg-background/80">
